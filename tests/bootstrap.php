<?php
/**
 * Term_Debt_Consolidator Test Bootstrapper.
 *
 * @since   1.0.0
 ...
 * @since 1.0.0
 */
function _manually_load_term_debt_consolidator_plugin() {
	...
	// Require our plugin.
	require dirname( dirname( __FILE__ ) ) . '/term-debt-consolidator.php';
}

// Inject in our plugin.
tests_add_filter( 'muplugins_loaded', '_manually_load_term_debt_consolidator_plugin' );
